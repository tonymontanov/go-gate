/*
FILE: flashswap/mapping.go

DESCRIPTION:
Shared wire ↔ domain helpers for the flashswap client: query-string
construction and Gate timestamp normalization. These mirror the equivalent
helpers in the other sections but are defined LOCALLY in the flashswap package
so it never imports another section.

GATE WIRE NOTES:
  - create_time / update_time arrive as epoch SECONDS; they are normalized to

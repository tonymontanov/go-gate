/*
FILE: delivery/trading.go

DESCRIPTION:
Trading sub-client for the Gate Delivery section. Implements:
  - CreateOrder          : POST   /delivery/{settle}/orders
  - CreateBatchOrders    : POST   /delivery/{settle}/batch_orders
  - ModifyOrder          : PUT    /delivery/{settle}/orders/{order_id}
  - ModifyBatchOrders    : sequential ModifyOrder (native batch_amend deferred)
  - CancelOrder          : DELETE /delivery/{settle}/orders/{order_id}
  - CancelBatchOrders    : POST   /delivery/{settle}/batch_cancel_orders
  - CancelAllOrders      : DELETE /delivery/{settle}/orders?contract=  (native)
  - CancelForgottenOrders: GetOpenOrders + age filter + CancelBatchOrders
  - CountdownCancelAll   : POST   /delivery/{settle}/countdown_cancel_all
  - GetOrder             : GET    /delivery/{settle}/orders/{order_id}
  - GetOpenOrders        : GET    /delivery/{settle}/orders?status=open&contract=
...
/*
CreateBatchOrders creates a batch of orders via POST /delivery/{settle}/batch_orders.
...
// DELETE /delivery/{settle}/orders?contract=.
...
// POST /delivery/{settle}/batch_cancel_orders (body: array of order ids). Returns
...
// (GET /delivery/{settle}/orders?status=open&contract=).
